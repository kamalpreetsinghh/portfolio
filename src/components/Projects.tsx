...
import { projects, projectsLightTheme } from "../data";
...
const Projects = () => {
  ...
  const projectsDetails = isDarkTheme ? projects : projectsLightTheme;
  const projectBackgroundColor = isDarkTheme ? "#13162D" : "#d9deff";
  ...
  return (
    <div className="py-8 md:py-16" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-16">
        {projectsDetails.map(
          ({ id, title, des, img, iconLists, link, url }) => (
            <div
